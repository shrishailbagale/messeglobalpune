	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<br> <strong
					style="color: red; background-color: white; margin-left: 100px;">
									...
									<table class="table align-items-center table-flush table-hover table-bordered"
										...
										<tbody>
											...
											<tr>
												...
												<td class="font-w600"><span class="badge badge-info">
												...
												<td class="d-sm-table-cell"><span
													class="badge approved"> <?php  echo htmlentities($row->Status);?>
												</span></td>
												<?php 
												} ?>
	...
	<script type="text/javascript">
		...
		function drawChart() {
			...
			var data = google.visualization.arrayToDataTable([
					[ 'Task', 'Hours per Day' ], [ 'Party decorations', 11 ],
					[ 'Party DJ', 2 ], [ 'Ceremony Music', 2 ],
					[ 'Uplighters', 2 ], [ 'Photo Booth Hire', 7 ] ]);
