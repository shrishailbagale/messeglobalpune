                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6"> 
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="eventdate" id="eventdate" placeholder="" value="2023-06-22">
                        </div>
                      </div>
                     ...
                     <div class="col-md-3">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="Shrishail Bagale">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="contact" id="contact" placeholder="contact" value="8888988708" required="true">
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="name">Email ID:</label>
                          <input type="text" class="form-control" name="email" id="contact" placeholder="contact" value="Enter valid Email" required="true">
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="name">Organization</label>
                          <input type="text" class="form-control" name="organiz" id="name" placeholder="Name" value="Individual">
                        </div>
                      </div>                    
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select type="text" class="form-control" name="placerequired" required="true" >
                            <option value="">Choose Place required</option>
                            <?php 
                            ...
                            {          
                              ?>  
                              <option value="<?php echo htmlentities($row->PlaceName);?>"><?php echo htmlentities($row->PlaceName);?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select type="text p-3" class="form-control" name="eventtype" required="true" >
                            ...
                            {          
                              ?>  
                              <option class="p-2" value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
                            <?php } ?>
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="pax" id="name" placeholder="Name" value="Individual">
                        </div>
                      </div>   
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="name">Reference</label>
                          <input type="text" class="form-control" name="refer" id="name" placeholder="Name" value="Individual">
                        </div>
                      </div>   
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="name">Handled By</label>
                          <input type="text" class="form-control" name="handle" id="name" placeholder="Name" value="Individual">
                        </div>
                      </div>   
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="#">Additional Information</label>
                          <textarea name="info" class="form-control" id="info" cols="30" rows="4" placeholder="" value="NA"></textarea>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
